...
$(".spinner *, .spinner").css("opacity",'1');
    ...
    else
    {
         $(".getImg").attr("src",a[0].IMG);     
                         for (var i=0; i < itemLength && (i<a.length); i++)
                          {
                              $(".button").append($("<a>")
 ...
 $(".circleButton").on("click",function()
                          {
                              ...
                              var choose = $(this).data("item");
                               ...
                               $(".brand").html(a[choose].BRAND)
                                //  .css({"font-family":"'Montserrat': sans-serif","font-weight":"bold"});
                          ...
                          $("#home").html(a[choose].DESCRIPTION)
                                 // .css({"font-family":"'Montserrat': sans-serif","font-weight":"bold","font-weight":"bold","min-height":'150px'})
